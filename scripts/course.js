...
const allButton = document.getElementById('all-courses');
const wddCoursesBtn = document.getElementById('wdd-courses');
const cseCoursesBtn = document.getElementById('cse-courses');
const coursesDisplay = document.getElementById('display-courses');

const displayCourses = (courseArray) => {
    ...
    const displayCredits = document.createElement('p');
    displayCredits.textContent = `Total credits: ${totalCredits}`;

    coursesDisplay.appendChild(displayCredits);
};
